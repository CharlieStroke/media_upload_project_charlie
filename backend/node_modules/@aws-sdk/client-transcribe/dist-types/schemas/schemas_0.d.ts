...
export declare var CallAnalyticsJobSummaries: StaticListSchema;
export declare var CallAnalyticsSkippedFeatureList: StaticListSchema;
export declare var CategoryPropertiesList: StaticListSchema;
export declare var ChannelDefinitions: StaticListSchema;
export declare var LanguageCodeList: StaticListSchema;
export declare var LanguageOptions: number;
export declare var MedicalScribeChannelDefinitions: StaticListSchema;
export declare var MedicalScribeJobSummaries: StaticListSchema;
export declare var MedicalTranscriptionJobSummaries: StaticListSchema;
export declare var Models: StaticListSchema;
export declare var Phrases: number;
export declare var PiiEntityTypes: number;
export declare var RuleList: StaticListSchema;
export declare var SentimentValueList: number;
export declare var StringTargetList: number;
export declare var SubtitleFileUris: number;
export declare var SubtitleFormats: number;
export declare var TagKeyList: number;
export declare var TagList: StaticListSchema;
export declare var ToxicityCategories: number;
export declare var ToxicityDetection: StaticListSchema;
export declare var TranscriptionJobSummaries: StaticListSchema;
export declare var Vocabularies: StaticListSchema;
export declare var VocabularyFilters: StaticListSchema;
export declare var Words: number;
export declare var KMSEncryptionContextMap: number;
export declare var LanguageIdSettingsMap: StaticMapSchema;
