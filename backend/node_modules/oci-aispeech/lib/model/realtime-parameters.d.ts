...
export declare namespace RealtimeParameters {
    enum StabilizePartialResults {
        None = "NONE",
        Low = "LOW",
        Medium = "MEDIUM",
        High = "HIGH"
    ...
    function getJsonObj(obj: RealtimeParameters): object;
    function getDeserializedJsonObj(obj: RealtimeParameters): object;
}
