...
export declare namespace TtsOracleSpeechSettings {
    enum TextType {
        Text = "TEXT",
        Ssml = "SSML"
    }
    ...
    enum SpeechMarkTypes {
        Sentence = "SENTENCE",
        Word = "WORD"
    }
    function getJsonObj(obj: TtsOracleSpeechSettings): object;
    function getDeserializedJsonObj(obj: TtsOracleSpeechSettings): object;
}
