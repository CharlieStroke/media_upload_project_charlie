...
export declare namespace TtsOracleTts2NaturalModelDetails {
    function getJsonObj(obj: TtsOracleTts2NaturalModelDetails, isParentJsonObj?: boolean): object;
    const modelName = "TTS_2_NATURAL";
    function getDeserializedJsonObj(obj: TtsOracleTts2NaturalModelDetails, isParentJsonObj?: boolean): object;
}
