...
exports.ChangeOracleDbAzureBlobMountCompartmentDetails = ChangeOracleDbAzureBlobMountCompartmentDetails.ChangeOracleDbAzureBlobMountCompartmentDetails;
const ChangeOracleDbAzureConnectorCompartmentDetails = __importStar(require("./change-oracle-db-azure-connector-compartment-details"));
exports.ChangeOracleDbAzureConnectorCompartmentDetails = ChangeOracleDbAzureConnectorCompartmentDetails.ChangeOracleDbAzureConnectorCompartmentDetails;
const ChangeOracleDbAzureVaultAssociationCompartmentDetails = __importStar(require("./change-oracle-db-azure-vault-association-compartment-details"));
exports.ChangeOracleDbAzureVaultAssociationCompartmentDetails = ChangeOracleDbAzureVaultAssociationCompartmentDetails.ChangeOracleDbAzureVaultAssociationCompartmentDetails;
const ChangeOracleDbAzureVaultCompartmentDetails = __importStar(require("./change-oracle-db-azure-vault-compartment-details"));
exports.ChangeOracleDbAzureVaultCompartmentDetails = ChangeOracleDbAzureVaultCompartmentDetails.ChangeOracleDbAzureVaultCompartmentDetails;
const ChangeOracleDbGcpIdentityConnectorCompartmentDetails = __importStar(require("./change-oracle-db-gcp-identity-connector-compartment-details"));
exports.ChangeOracleDbGcpIdentityConnectorCompartmentDetails = ChangeOracleDbGcpIdentityConnectorCompartmentDetails.ChangeOracleDbGcpIdentityConnectorCompartmentDetails;
const ChangeOracleDbGcpKeyRingCompartmentDetails = __importStar(require("./change-oracle-db-gcp-key-ring-compartment-details"));
...
exports.CreateOracleDbAzureBlobMountDetails = CreateOracleDbAzureBlobMountDetails.CreateOracleDbAzureBlobMountDetails;
const CreateOracleDbAzureConnectorDetails = __importStar(require("./create-oracle-db-azure-connector-details"));
exports.CreateOracleDbAzureConnectorDetails = CreateOracleDbAzureConnectorDetails.CreateOracleDbAzureConnectorDetails;
const CreateOracleDbAzureVaultAssociationDetails = __importStar(require("./create-oracle-db-azure-vault-association-details"));
exports.CreateOracleDbAzureVaultAssociationDetails = CreateOracleDbAzureVaultAssociationDetails.CreateOracleDbAzureVaultAssociationDetails;
const CreateOracleDbAzureVaultDetails = __importStar(require("./create-oracle-db-azure-vault-details"));
exports.CreateOracleDbAzureVaultDetails = CreateOracleDbAzureVaultDetails.CreateOracleDbAzureVaultDetails;
const CreateOracleDbGcpIdentityConnectorDetails = __importStar(require("./create-oracle-db-gcp-identity-connector-details"));
exports.CreateOracleDbGcpIdentityConnectorDetails = CreateOracleDbGcpIdentityConnectorDetails.CreateOracleDbGcpIdentityConnectorDetails;
const CreateOracleDbGcpKeyRingDetails = __importStar(require("./create-oracle-db-gcp-key-ring-details"));
exports.CreateOracleDbGcpKeyRingDetails = CreateOracleDbGcpKeyRingDetails.CreateOracleDbGcpKeyRingDetails;
const GcpNodes = __importStar(require("./gcp-nodes"));
exports.GcpNodes = GcpNodes.GcpNodes;
const MultiCloudResourceDiscovery = __importStar(require("./multi-cloud-resource-discovery"));
exports.MultiCloudResourceDiscovery = MultiCloudResourceDiscovery.MultiCloudResourceDiscovery;
const MultiCloudResourceDiscoverySummary = __importStar(require("./multi-cloud-resource-discovery-summary"));
exports.MultiCloudResourceDiscoverySummary = MultiCloudResourceDiscoverySummary.MultiCloudResourceDiscoverySummary;
const MultiCloudResourceDiscoverySummaryCollection = __importStar(require("./multi-cloud-resource-discovery-summary-collection"));
exports.MultiCloudResourceDiscoverySummaryCollection = MultiCloudResourceDiscoverySummaryCollection.MultiCloudResourceDiscoverySummaryCollection;
...
exports.OracleDbAzureBlobContainerSummary = OracleDbAzureBlobContainerSummary.OracleDbAzureBlobContainerSummary;
const OracleDbAzureBlobContainerSummaryCollection = __importStar(require("./oracle-db-azure-blob-container-summary-collection"));
exports.OracleDbAzureBlobContainerSummaryCollection = OracleDbAzureBlobContainerSummaryCollection.OracleDbAzureBlobContainerSummaryCollection;
const OracleDbAzureBlobMount = __importStar(require("./oracle-db-azure-blob-mount"));
exports.OracleDbAzureBlobMount = OracleDbAzureBlobMount.OracleDbAzureBlobMount;
const OracleDbAzureBlobMountSummary = __importStar(require("./oracle-db-azure-blob-mount-summary"));
exports.OracleDbAzureBlobMountSummary = OracleDbAzureBlobMountSummary.OracleDbAzureBlobMountSummary;
const OracleDbAzureBlobMountSummaryCollection = __importStar(require("./oracle-db-azure-blob-mount-summary-collection"));
exports.OracleDbAzureBlobMountSummaryCollection = OracleDbAzureBlobMountSummaryCollection.OracleDbAzureBlobMountSummaryCollection;
const OracleDbAzureConnector = __importStar(require("./oracle-db-azure-connector"));
exports.OracleDbAzureConnector = OracleDbAzureConnector.OracleDbAzureConnector;
const OracleDbAzureConnectorSummary = __importStar(require("./oracle-db-azure-connector-summary"));
exports.OracleDbAzureConnectorSummary = OracleDbAzureConnectorSummary.OracleDbAzureConnectorSummary;
const OracleDbAzureConnectorSummaryCollection = __importStar(require("./oracle-db-azure-connector-summary-collection"));
exports.OracleDbAzureConnectorSummaryCollection = OracleDbAzureConnectorSummaryCollection.OracleDbAzureConnectorSummaryCollection;
const OracleDbAzureKey = __importStar(require("./oracle-db-azure-key"));
exports.OracleDbAzureKey = OracleDbAzureKey.OracleDbAzureKey;
const OracleDbAzureKeySummary = __importStar(require("./oracle-db-azure-key-summary"));
exports.OracleDbAzureKeySummary = OracleDbAzureKeySummary.OracleDbAzureKeySummary;
const OracleDbAzureKeySummaryCollection = __importStar(require("./oracle-db-azure-key-summary-collection"));
exports.OracleDbAzureKeySummaryCollection = OracleDbAzureKeySummaryCollection.OracleDbAzureKeySummaryCollection;
const OracleDbAzureVault = __importStar(require("./oracle-db-azure-vault"));
exports.OracleDbAzureVault = OracleDbAzureVault.OracleDbAzureVault;
const OracleDbAzureVaultAssociation = __importStar(require("./oracle-db-azure-vault-association"));
exports.OracleDbAzureVaultAssociation = OracleDbAzureVaultAssociation.OracleDbAzureVaultAssociation;
const OracleDbAzureVaultAssociationSummary = __importStar(require("./oracle-db-azure-vault-association-summary"));
exports.OracleDbAzureVaultAssociationSummary = OracleDbAzureVaultAssociationSummary.OracleDbAzureVaultAssociationSummary;
const OracleDbAzureVaultAssociationSummaryCollection = __importStar(require("./oracle-db-azure-vault-association-summary-collection"));
exports.OracleDbAzureVaultAssociationSummaryCollection = OracleDbAzureVaultAssociationSummaryCollection.OracleDbAzureVaultAssociationSummaryCollection;
const OracleDbAzureVaultSummary = __importStar(require("./oracle-db-azure-vault-summary"));
exports.OracleDbAzureVaultSummary = OracleDbAzureVaultSummary.OracleDbAzureVaultSummary;
const OracleDbAzureVaultSummaryCollection = __importStar(require("./oracle-db-azure-vault-summary-collection"));
exports.OracleDbAzureVaultSummaryCollection = OracleDbAzureVaultSummaryCollection.OracleDbAzureVaultSummaryCollection;
const OracleDbGcpIdentityConnector = __importStar(require("./oracle-db-gcp-identity-connector"));
exports.OracleDbGcpIdentityConnector = OracleDbGcpIdentityConnector.OracleDbGcpIdentityConnector;
const OracleDbGcpIdentityConnectorSummary = __importStar(require("./oracle-db-gcp-identity-connector-summary"));
exports.OracleDbGcpIdentityConnectorSummary = OracleDbGcpIdentityConnectorSummary.OracleDbGcpIdentityConnectorSummary;
const OracleDbGcpIdentityConnectorSummaryCollection = __importStar(require("./oracle-db-gcp-identity-connector-summary-collection"));
exports.OracleDbGcpIdentityConnectorSummaryCollection = OracleDbGcpIdentityConnectorSummaryCollection.OracleDbGcpIdentityConnectorSummaryCollection;
const OracleDbGcpKey = __importStar(require("./oracle-db-gcp-key"));
exports.OracleDbGcpKey = OracleDbGcpKey.OracleDbGcpKey;
const OracleDbGcpKeyRing = __importStar(require("./oracle-db-gcp-key-ring"));
exports.OracleDbGcpKeyRing = OracleDbGcpKeyRing.OracleDbGcpKeyRing;
const OracleDbGcpKeyRingSummary = __importStar(require("./oracle-db-gcp-key-ring-summary"));
exports.OracleDbGcpKeyRingSummary = OracleDbGcpKeyRingSummary.OracleDbGcpKeyRingSummary;
const OracleDbGcpKeyRingSummaryCollection = __importStar(require("./oracle-db-gcp-key-ring-summary-collection"));
exports.OracleDbGcpKeyRingSummaryCollection = OracleDbGcpKeyRingSummaryCollection.OracleDbGcpKeyRingSummaryCollection;
const OracleDbGcpKeySummary = __importStar(require("./oracle-db-gcp-key-summary"));
exports.OracleDbGcpKeySummary = OracleDbGcpKeySummary.OracleDbGcpKeySummary;
const OracleDbGcpKeySummaryCollection = __importStar(require("./oracle-db-gcp-key-summary-collection"));
...
exports.UpdateOracleDbAzureBlobMountDetails = UpdateOracleDbAzureBlobMountDetails.UpdateOracleDbAzureBlobMountDetails;
const UpdateOracleDbAzureConnectorDetails = __importStar(require("./update-oracle-db-azure-connector-details"));
exports.UpdateOracleDbAzureConnectorDetails = UpdateOracleDbAzureConnectorDetails.UpdateOracleDbAzureConnectorDetails;
const UpdateOracleDbAzureVaultAssociationDetails = __importStar(require("./update-oracle-db-azure-vault-association-details"));
exports.UpdateOracleDbAzureVaultAssociationDetails = UpdateOracleDbAzureVaultAssociationDetails.UpdateOracleDbAzureVaultAssociationDetails;
const UpdateOracleDbAzureVaultDetails = __importStar(require("./update-oracle-db-azure-vault-details"));
exports.UpdateOracleDbAzureVaultDetails = UpdateOracleDbAzureVaultDetails.UpdateOracleDbAzureVaultDetails;
const UpdateOracleDbGcpIdentityConnectorDetails = __importStar(require("./update-oracle-db-gcp-identity-connector-details"));
exports.UpdateOracleDbGcpIdentityConnectorDetails = UpdateOracleDbGcpIdentityConnectorDetails.UpdateOracleDbGcpIdentityConnectorDetails;
const UpdateOracleDbGcpKeyRingDetails = __importStar(require("./update-oracle-db-gcp-key-ring-details"));
exports.UpdateOracleDbGcpKeyRingDetails = UpdateOracleDbGcpKeyRingDetails.UpdateOracleDbGcpKeyRingDetails;
