...
export declare class DevopsClient {
     ...
     */
    getPullRequestChangeSummaryMetrics(getPullRequestChangeSummaryMetricsRequest: requests.GetPullRequestChangeSummaryMetricsRequest): Promise<responses.GetPullRequestChangeSummaryMetricsResponse>;
    /**
     ...
     */
    listPullRequestCommits(listPullRequestCommitsRequest: requests.ListPullRequestCommitsRequest): Promise<responses.ListPullRequestCommitsResponse>;
    /**
     ...
     */
    listPullRequestFileChanges(listPullRequestFileChangesRequest: requests.ListPullRequestFileChangesRequest): Promise<responses.ListPullRequestFileChangesResponse>;
    /**
