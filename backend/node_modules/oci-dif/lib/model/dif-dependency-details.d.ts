...
export declare namespace DifDependencyDetails {
    function getJsonObj(obj: DifDependencyDetails): object;
    function getDeserializedJsonObj(obj: DifDependencyDetails): object;
}
