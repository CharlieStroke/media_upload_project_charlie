...
export declare namespace EndpointAdditional {
    function getJsonObj(obj: EndpointAdditional): object;
    function getDeserializedJsonObj(obj: EndpointAdditional): object;
}
