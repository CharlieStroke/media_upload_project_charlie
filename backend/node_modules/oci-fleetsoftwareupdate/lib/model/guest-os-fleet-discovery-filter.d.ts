...
export declare namespace GuestOsFleetDiscoveryFilter {
    enum Mode {
        Include = "INCLUDE",
        Exclude = "EXCLUDE",
        /**
    ...
    function getJsonObj(obj: GuestOsFleetDiscoveryFilter): object;
    function getDeserializedJsonObj(obj: GuestOsFleetDiscoveryFilter): object;
}
