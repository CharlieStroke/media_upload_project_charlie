 ...
 */
export interface JsonSchemaResponseFormat extends model.ResponseFormat {
    "jsonSchema"?: model.ResponseJsonSchema;
    "type": string;
}
export declare namespace JsonSchemaResponseFormat {
    function getJsonObj(obj: JsonSchemaResponseFormat, isParentJsonObj?: boolean): object;
    const type = "JSON_SCHEMA";
    function getDeserializedJsonObj(obj: JsonSchemaResponseFormat, isParentJsonObj?: boolean): object;
}
