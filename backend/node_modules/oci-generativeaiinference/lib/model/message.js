...
(function (Message) {
    function getJsonObj(obj) {
        ...
        if (obj && "role" in obj && obj.role) {
            switch (obj.role) {
                case "SYSTEM":
                    return model.SystemMessage.getJsonObj(jsonObj, true);
                case "ASSISTANT":
                ...
                case "DEVELOPER":
                    return model.DeveloperMessage.getJsonObj(jsonObj, true);
                default:
    ...
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "role" in obj && obj.role) {
            switch (obj.role) {
                case "SYSTEM":
                    return model.SystemMessage.getDeserializedJsonObj(jsonObj, true);
                case "ASSISTANT":
                ...
                case "DEVELOPER":
                    return model.DeveloperMessage.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.role}`);
            }
