...
(function (Prediction) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "CONTENT":
                    return model.StaticContent.getJsonObj(jsonObj, true);
                default:
    ...
    Prediction.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "CONTENT":
                    return model.StaticContent.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    Prediction.getDeserializedJsonObj = getDeserializedJsonObj;
