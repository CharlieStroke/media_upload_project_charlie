...
(function (ResponseFormat) {
    function getJsonObj(obj) {
        ...
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.TextResponseFormat.getJsonObj(jsonObj, true);
                case "JSON_OBJECT":
                    return model.JsonObjectResponseFormat.getJsonObj(jsonObj, true);
                case "JSON_SCHEMA":
                    return model.JsonSchemaResponseFormat.getJsonObj(jsonObj, true);
                default:
    ...
    ResponseFormat.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        const jsonObj = Object.assign(Object.assign({}, obj), {});
        if (obj && "type" in obj && obj.type) {
            switch (obj.type) {
                case "TEXT":
                    return model.TextResponseFormat.getDeserializedJsonObj(jsonObj, true);
                case "JSON_OBJECT":
                    return model.JsonObjectResponseFormat.getDeserializedJsonObj(jsonObj, true);
                case "JSON_SCHEMA":
                    return model.JsonSchemaResponseFormat.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.type}`);
            }
    ...
    ResponseFormat.getDeserializedJsonObj = getDeserializedJsonObj;
