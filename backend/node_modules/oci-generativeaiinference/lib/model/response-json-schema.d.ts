...
export declare namespace ResponseJsonSchema {
    function getJsonObj(obj: ResponseJsonSchema): object;
    function getDeserializedJsonObj(obj: ResponseJsonSchema): object;
}
