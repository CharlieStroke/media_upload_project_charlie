...
export declare namespace StaticContent {
    function getJsonObj(obj: StaticContent, isParentJsonObj?: boolean): object;
    const type = "CONTENT";
    function getDeserializedJsonObj(obj: StaticContent, isParentJsonObj?: boolean): object;
}
