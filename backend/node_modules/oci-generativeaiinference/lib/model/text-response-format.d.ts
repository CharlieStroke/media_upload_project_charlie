 ...
 * Enables TEXT mode.
 */
export interface TextResponseFormat extends model.ResponseFormat {
    "type": string;
}
export declare namespace TextResponseFormat {
    function getJsonObj(obj: TextResponseFormat, isParentJsonObj?: boolean): object;
    const type = "TEXT";
    function getDeserializedJsonObj(obj: TextResponseFormat, isParentJsonObj?: boolean): object;
}
