...
export declare namespace OciListingRevision {
    enum PricingType {
        Free = "FREE",
        Byol = "BYOL",
        Paygo = "PAYGO",
    ...
    function getJsonObj(obj: OciListingRevision, isParentJsonObj?: boolean): object;
    const listingType = "OCI_APPLICATION";
    function getDeserializedJsonObj(obj: OciListingRevision, isParentJsonObj?: boolean): object;
}
