...
export declare namespace SupportDocCollection {
    function getJsonObj(obj: SupportDocCollection): object;
    function getDeserializedJsonObj(obj: SupportDocCollection): object;
}
