...
export declare namespace SupportedShapeSummary {
    function getJsonObj(obj: SupportedShapeSummary): object;
    function getDeserializedJsonObj(obj: SupportedShapeSummary): object;
}
