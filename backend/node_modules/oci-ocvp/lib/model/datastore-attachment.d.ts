...
export declare namespace DatastoreAttachment {
    function getJsonObj(obj: DatastoreAttachment): object;
    function getDeserializedJsonObj(obj: DatastoreAttachment): object;
}
