...
exports.CrossConnectMapping = exports.CrossConnectLocation = exports.CrossConnectGroup = exports.CrossConnect = exports.CreateVirtualCircuitPublicPrefixDetails = exports.CreateVirtualCircuitDetails = exports.CreateVcnDetails = exports.CreateSubnetDetails = exports.CreateServiceGatewayDetails = exports.CreateSecurityListDetails = exports.CreateRouteTableDetails = exports.CreateRemotePeeringConnectionDetails = exports.CreatePublicIpDetails = exports.CreatePrivateIpDetails = exports.CreatePathAnalyzerTestDetails = exports.CreateNetworkSecurityGroupDetails = exports.CreateLocalPeeringGatewayDetails = exports.CreateIpv6Details = exports.CreateInternetGatewayDetails = exports.CreateIPSecConnectionDetails = exports.CreateFlexTunnelDetails = exports.CreateFlexTunnelConfigurationDetails = exports.CreateFlexTunnelBgpSessionDetails = exports.CreateDrgRouteTableDetails = exports.CreateDrgRouteDistributionDetails = exports.CreateDrgDetails = exports.CreateDrgAttachmentDetails = exports.CreateDhcpDetails = exports.CreateCrossConnectGroupDetails = exports.CreateCrossConnectDetails = exports.CreateCpeDetails = exports.Cpe = exports.ConnectRemotePeeringConnectionsDetails = exports.ConnectLocalPeeringGatewaysDetails = exports.CompartmentInternal = exports.ChangePathAnalyzerTestCompartmentDetails = exports.ChangeFlexTunnelCompartmentDetails = exports.ChangeDrgAttachmentCompartmentDetails = exports.BulkDeleteVirtualCircuitPublicPrefixesDetails = exports.BulkAddVirtualCircuitPublicPrefixesDetails = exports.AllowedSecurityConfiguration = exports.AllowedSecurityActionDetails = exports.AddedNetworkSecurityGroupSecurityRules = exports.AddSecurityRuleDetails = exports.AddNetworkSecurityGroupSecurityRulesDetails = exports.AddDrgRouteRulesDetails = exports.AddDrgRouteRuleDetails = exports.AddDrgRouteDistributionStatementsDetails = exports.AddDrgRouteDistributionStatementDetails = exports.ActionType = void 0;
exports.OperationStatus = exports.NoRouteRoutingActionDetails = exports.NetworkSecurityGroupVnic = exports.NetworkSecurityGroup = exports.LocalPeeringGateway = exports.LetterOfAuthority = exports.Ipv6 = exports.InternetGateway = exports.IngressSecurityRule = exports.IcmpOptions = exports.IPSecConnectionDeviceStatus = exports.IPSecConnectionDeviceConfig = exports.IPSecConnection = exports.GetPublicIpByPrivateIpIdDetails = exports.GetPublicIpByIpAddressDetails = exports.GetPathAnalysisDetails = exports.ForwardedRoutingConfiguration = exports.ForwardedRoutingActionDetails = exports.FlexTunnelSummary = exports.FlexTunnelRouteSummary = exports.FlexTunnelConfiguration = exports.FlexTunnelCollection = exports.FlexTunnelBgpStatus = exports.FlexTunnelBgpSession = exports.FlexTunnel = exports.FastConnectProviderService = exports.Endpoint = exports.EgressTrafficSpec = exports.EgressSecurityRule = exports.DrgRouteTable = exports.DrgRouteRule = exports.DrgRouteDistributionStatement = exports.DrgRouteDistributionMatchCriteria = exports.DrgRouteDistribution = exports.DrgPromotionStatusResponse = exports.DrgCustomerResource = exports.DrgCustomer = exports.DrgAttachmentNetworkUpdateDetails = exports.DrgAttachmentNetworkDetails = exports.DrgAttachmentNetworkCreateDetails = exports.DrgAttachmentInfo = exports.DrgAttachment = exports.Drg = exports.DhcpOptions = exports.DhcpOption = exports.DeniedSecurityActionDetails = exports.DeleteVirtualCircuitPublicPrefixDetails = exports.DefaultDrgRouteTables = exports.CrossConnectStatus = exports.CrossConnectPortSpeedShape = void 0;
exports.UpdateDrgRouteTableDetails = exports.UpdateDrgRouteRulesDetails = exports.UpdateDrgRouteRuleDetails = exports.UpdateDrgRouteDistributionStatementsDetails = exports.UpdateDrgRouteDistributionStatementDetails = exports.UpdateDrgRouteDistributionDetails = exports.UpdateDrgDetails = exports.UpdateDrgAttachmentDetails = exports.UpdateDhcpDetails = exports.UpdateCrossConnectGroupDetails = exports.UpdateCrossConnectDetails = exports.UpdateCpeDetails = exports.UdpOptions = exports.TunnelStatus = exports.TunnelConfig = exports.TrafficRoute = exports.TrafficProtocolParameters = exports.TrafficNode = exports.TopologyRoutesToRelationshipDetails = exports.TopologyEntityRelationship = exports.TopologyAssociatedWithRelationshipDetails = exports.Topology = exports.TcpOptions = exports.Subnet = exports.SortOrder = exports.SetDrgPeeringConnectionDetails = exports.ServiceIdResponseDetails = exports.ServiceIdRequestDetails = exports.ServiceGateway = exports.Service = exports.SecurityRule = exports.SecurityList = exports.SecurityAction = exports.RoutingAction = exports.RouteTable = exports.RouteRule = exports.RemoveNetworkSecurityGroupSecurityRulesDetails = exports.RemoveDrgRouteRulesDetails = exports.RemoveDrgRouteDistributionStatementsDetails = exports.RemotePeeringConnection = exports.QueryOptions = exports.PublicIp = exports.ProtocolParameters = exports.PrivateIp = exports.PortRange = exports.PathAnalyzerTestSummary = exports.PathAnalyzerTestCollection = exports.PathAnalyzerTest = exports.Path = exports.OperationType = void 0;
exports.DeniedSecurityAction = exports.CreateGreFlexTunnelConfigurationDetails = exports.ComputeInstanceEndpoint = exports.AllowedSecurityAction = exports.AdhocGetPathAnalysisDetails = exports.AccessDeniedTrafficNode = exports.ZprPolicy = exports.ZprNsgUnsupportedSecurityActionDetails = exports.ZprDeniedSecurityActionDetails = exports.ZprCidrUnsupportedSecurityActionDetails = exports.ZprAllowedSecurityActionDetails = exports.WorkRequestSummaryCollection = exports.WorkRequestSummary = exports.WorkRequestResultCollection = exports.WorkRequestResult = exports.WorkRequestResource = exports.WorkRequestLogEntryCollection = exports.WorkRequestLogEntry = exports.WorkRequestErrorCollection = exports.WorkRequestError = exports.WorkRequest = exports.Vnic = exports.VirtualCircuitPublicPrefix = exports.VirtualCircuitBandwidthShape = exports.VirtualCircuitAssociatedTunnelDetails = exports.VirtualCircuit = exports.Vcn = exports.UpgradeStatus = exports.UpdatedNetworkSecurityGroupSecurityRules = exports.UpdateVnicDetails = exports.UpdateVirtualCircuitDetails = exports.UpdateVcnDetails = exports.UpdateSubnetDetails = exports.UpdateServiceGatewayDetails = exports.UpdateSecurityRuleDetails = exports.UpdateSecurityListDetails = exports.UpdateRouteTableDetails = exports.UpdateRemotePeeringConnectionDetails = exports.UpdatePublicIpDetails = exports.UpdatePrivateIpDetails = exports.UpdatePathAnalyzerTestDetails = exports.UpdateNetworkSecurityGroupSecurityRulesDetails = exports.UpdateNetworkSecurityGroupDetails = exports.UpdateLocalPeeringGatewayDetails = exports.UpdateIpv6Details = exports.UpdateInternetGatewayDetails = exports.UpdateIPSecConnectionDetails = exports.UpdateFlexTunnelDetails = exports.UpdateFlexTunnelConfigurationDetails = exports.UpdateFlexTunnelBgpSessionDetails = void 0;
exports.UdpTrafficProtocolParameters = exports.UdpProtocolParameters = exports.TopologyRoutesToEntityRelationship = exports.TopologyContainsEntityRelationship = exports.TopologyAssociatedWithEntityRelationship = exports.TcpTrafficProtocolParameters = exports.TcpProtocolParameters = exports.SubnetTopology = exports.SubnetEndpoint = exports.StatefulZprConfiguration = exports.StatefulNsgConfiguration = exports.StatefulIngressSecurityListConfiguration = exports.StatefulEgressSecurityListConfiguration = exports.RemotePeeringConnectionDrgAttachmentNetworkDetails = exports.RemotePeeringConnectionDrgAttachmentNetworkCreateDetails = exports.PrivateServiceAccessEndpoint = exports.PersistedGetPathAnalysisDetails = exports.PathTopology = exports.PathAnalysisWorkRequestResult = exports.OnPremEndpoint = exports.NsgConfiguration = exports.NoRouteRoutingAction = exports.NetworkingTopology = exports.NetworkLoadBalancerListenerEndpoint = exports.NetworkLoadBalancerEndpoint = exports.LoopbackDrgAttachmentNetworkUpdateDetails = exports.LoopBackDrgAttachmentNetworkDetails = exports.LoopBackDrgAttachmentNetworkCreateDetails = exports.LoadBalancerListenerEndpoint = exports.LoadBalancerEndpoint = exports.IpsecTunnelDrgAttachmentNetworkDetails = exports.IpsecTunnelDrgAttachmentNetworkCreateDetails = exports.IpAddressEndpoint = exports.InternetDrgAttachmentNetworkUpdateDetails = exports.InternetDrgAttachmentNetworkDetails = exports.InternetDrgAttachmentNetworkCreateDetails = exports.IngressSecurityListConfiguration = exports.IndeterminateRoutingAction = exports.IcmpTrafficProtocolParameters = exports.IcmpProtocolParameters = exports.GreFlexTunnelConfiguration = exports.ForwardedRoutingAction = exports.FlexTunnelDrgAttachmentNetworkDetails = exports.FlexTunnelDrgAttachmentNetworkCreateDetails = exports.EgressSecurityListConfiguration = exports.DrgRoutingConfiguration = exports.DrgAttachmentTypeDrgRouteDistributionMatchCriteria = exports.DrgAttachmentIdDrgRouteDistributionMatchCriteria = exports.DhcpSearchDomainOption = exports.DhcpDnsOption = void 0;
exports.ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction = exports.ZprPolicyNotEvaluatedMissingRouteSecurityAction = exports.ZprNsgUnsupportedSecurityAction = exports.ZprMissingPolicySecurityAction = exports.ZprDeniedSecurityAction = exports.ZprConfiguration = exports.ZprCidrUnsupportedSecurityAction = exports.ZprAllowedSecurityAction = exports.VnicEndpoint = exports.VlanEndpoint = exports.VisibleTrafficNode = exports.VirtualCircuitDrgAttachmentNetworkUpdateDetails = exports.VirtualCircuitDrgAttachmentNetworkDetails = exports.VirtualCircuitDrgAttachmentNetworkCreateDetails = exports.VcnTopology = exports.VcnRoutingConfiguration = exports.VcnDrgAttachmentNetworkUpdateDetails = exports.VcnDrgAttachmentNetworkDetails = exports.VcnDrgAttachmentNetworkCreateDetails = exports.UpdateGreFlexTunnelConfigurationDetails = void 0;
...
const ChangeDrgAttachmentCompartmentDetails = __importStar(require("./change-drg-attachment-compartment-details"));
exports.ChangeDrgAttachmentCompartmentDetails = ChangeDrgAttachmentCompartmentDetails.ChangeDrgAttachmentCompartmentDetails;
const ChangeFlexTunnelCompartmentDetails = __importStar(require("./change-flex-tunnel-compartment-details"));
exports.ChangeFlexTunnelCompartmentDetails = ChangeFlexTunnelCompartmentDetails.ChangeFlexTunnelCompartmentDetails;
...
const CreateFlexTunnelBgpSessionDetails = __importStar(require("./create-flex-tunnel-bgp-session-details"));
exports.CreateFlexTunnelBgpSessionDetails = CreateFlexTunnelBgpSessionDetails.CreateFlexTunnelBgpSessionDetails;
const CreateFlexTunnelConfigurationDetails = __importStar(require("./create-flex-tunnel-configuration-details"));
exports.CreateFlexTunnelConfigurationDetails = CreateFlexTunnelConfigurationDetails.CreateFlexTunnelConfigurationDetails;
const CreateFlexTunnelDetails = __importStar(require("./create-flex-tunnel-details"));
exports.CreateFlexTunnelDetails = CreateFlexTunnelDetails.CreateFlexTunnelDetails;
...
const FlexTunnel = __importStar(require("./flex-tunnel"));
exports.FlexTunnel = FlexTunnel.FlexTunnel;
const FlexTunnelBgpSession = __importStar(require("./flex-tunnel-bgp-session"));
exports.FlexTunnelBgpSession = FlexTunnelBgpSession.FlexTunnelBgpSession;
const FlexTunnelBgpStatus = __importStar(require("./flex-tunnel-bgp-status"));
exports.FlexTunnelBgpStatus = FlexTunnelBgpStatus.FlexTunnelBgpStatus;
const FlexTunnelCollection = __importStar(require("./flex-tunnel-collection"));
exports.FlexTunnelCollection = FlexTunnelCollection.FlexTunnelCollection;
const FlexTunnelConfiguration = __importStar(require("./flex-tunnel-configuration"));
exports.FlexTunnelConfiguration = FlexTunnelConfiguration.FlexTunnelConfiguration;
const FlexTunnelRouteSummary = __importStar(require("./flex-tunnel-route-summary"));
exports.FlexTunnelRouteSummary = FlexTunnelRouteSummary.FlexTunnelRouteSummary;
const FlexTunnelSummary = __importStar(require("./flex-tunnel-summary"));
exports.FlexTunnelSummary = FlexTunnelSummary.FlexTunnelSummary;
...
const SetDrgPeeringConnectionDetails = __importStar(require("./set-drg-peering-connection-details"));
exports.SetDrgPeeringConnectionDetails = SetDrgPeeringConnectionDetails.SetDrgPeeringConnectionDetails;
...
const UpdateFlexTunnelBgpSessionDetails = __importStar(require("./update-flex-tunnel-bgp-session-details"));
exports.UpdateFlexTunnelBgpSessionDetails = UpdateFlexTunnelBgpSessionDetails.UpdateFlexTunnelBgpSessionDetails;
const UpdateFlexTunnelConfigurationDetails = __importStar(require("./update-flex-tunnel-configuration-details"));
exports.UpdateFlexTunnelConfigurationDetails = UpdateFlexTunnelConfigurationDetails.UpdateFlexTunnelConfigurationDetails;
const UpdateFlexTunnelDetails = __importStar(require("./update-flex-tunnel-details"));
exports.UpdateFlexTunnelDetails = UpdateFlexTunnelDetails.UpdateFlexTunnelDetails;
...
const ZprAllowedSecurityActionDetails = __importStar(require("./zpr-allowed-security-action-details"));
exports.ZprAllowedSecurityActionDetails = ZprAllowedSecurityActionDetails.ZprAllowedSecurityActionDetails;
const ZprCidrUnsupportedSecurityActionDetails = __importStar(require("./zpr-cidr-unsupported-security-action-details"));
exports.ZprCidrUnsupportedSecurityActionDetails = ZprCidrUnsupportedSecurityActionDetails.ZprCidrUnsupportedSecurityActionDetails;
const ZprDeniedSecurityActionDetails = __importStar(require("./zpr-denied-security-action-details"));
exports.ZprDeniedSecurityActionDetails = ZprDeniedSecurityActionDetails.ZprDeniedSecurityActionDetails;
const ZprNsgUnsupportedSecurityActionDetails = __importStar(require("./zpr-nsg-unsupported-security-action-details"));
exports.ZprNsgUnsupportedSecurityActionDetails = ZprNsgUnsupportedSecurityActionDetails.ZprNsgUnsupportedSecurityActionDetails;
...
const CreateGreFlexTunnelConfigurationDetails = __importStar(require("./create-gre-flex-tunnel-configuration-details"));
exports.CreateGreFlexTunnelConfigurationDetails = CreateGreFlexTunnelConfigurationDetails.CreateGreFlexTunnelConfigurationDetails;
...
const FlexTunnelDrgAttachmentNetworkCreateDetails = __importStar(require("./flex-tunnel-drg-attachment-network-create-details"));
exports.FlexTunnelDrgAttachmentNetworkCreateDetails = FlexTunnelDrgAttachmentNetworkCreateDetails.FlexTunnelDrgAttachmentNetworkCreateDetails;
const FlexTunnelDrgAttachmentNetworkDetails = __importStar(require("./flex-tunnel-drg-attachment-network-details"));
exports.FlexTunnelDrgAttachmentNetworkDetails = FlexTunnelDrgAttachmentNetworkDetails.FlexTunnelDrgAttachmentNetworkDetails;
...
const GreFlexTunnelConfiguration = __importStar(require("./gre-flex-tunnel-configuration"));
exports.GreFlexTunnelConfiguration = GreFlexTunnelConfiguration.GreFlexTunnelConfiguration;
...
const InternetDrgAttachmentNetworkCreateDetails = __importStar(require("./internet-drg-attachment-network-create-details"));
exports.InternetDrgAttachmentNetworkCreateDetails = InternetDrgAttachmentNetworkCreateDetails.InternetDrgAttachmentNetworkCreateDetails;
const InternetDrgAttachmentNetworkDetails = __importStar(require("./internet-drg-attachment-network-details"));
exports.InternetDrgAttachmentNetworkDetails = InternetDrgAttachmentNetworkDetails.InternetDrgAttachmentNetworkDetails;
const InternetDrgAttachmentNetworkUpdateDetails = __importStar(require("./internet-drg-attachment-network-update-details"));
exports.InternetDrgAttachmentNetworkUpdateDetails = InternetDrgAttachmentNetworkUpdateDetails.InternetDrgAttachmentNetworkUpdateDetails;
...
const IpsecTunnelDrgAttachmentNetworkCreateDetails = __importStar(require("./ipsec-tunnel-drg-attachment-network-create-details"));
exports.IpsecTunnelDrgAttachmentNetworkCreateDetails = IpsecTunnelDrgAttachmentNetworkCreateDetails.IpsecTunnelDrgAttachmentNetworkCreateDetails;
...
const LoopBackDrgAttachmentNetworkCreateDetails = __importStar(require("./loop-back-drg-attachment-network-create-details"));
exports.LoopBackDrgAttachmentNetworkCreateDetails = LoopBackDrgAttachmentNetworkCreateDetails.LoopBackDrgAttachmentNetworkCreateDetails;
...
const LoopbackDrgAttachmentNetworkUpdateDetails = __importStar(require("./loopback-drg-attachment-network-update-details"));
exports.LoopbackDrgAttachmentNetworkUpdateDetails = LoopbackDrgAttachmentNetworkUpdateDetails.LoopbackDrgAttachmentNetworkUpdateDetails;
...
const PrivateServiceAccessEndpoint = __importStar(require("./private-service-access-endpoint"));
exports.PrivateServiceAccessEndpoint = PrivateServiceAccessEndpoint.PrivateServiceAccessEndpoint;
const RemotePeeringConnectionDrgAttachmentNetworkCreateDetails = __importStar(require("./remote-peering-connection-drg-attachment-network-create-details"));
exports.RemotePeeringConnectionDrgAttachmentNetworkCreateDetails = RemotePeeringConnectionDrgAttachmentNetworkCreateDetails.RemotePeeringConnectionDrgAttachmentNetworkCreateDetails;
...
const StatefulZprConfiguration = __importStar(require("./stateful-zpr-configuration"));
exports.StatefulZprConfiguration = StatefulZprConfiguration.StatefulZprConfiguration;
...
const UpdateGreFlexTunnelConfigurationDetails = __importStar(require("./update-gre-flex-tunnel-configuration-details"));
exports.UpdateGreFlexTunnelConfigurationDetails = UpdateGreFlexTunnelConfigurationDetails.UpdateGreFlexTunnelConfigurationDetails;
...
const VirtualCircuitDrgAttachmentNetworkCreateDetails = __importStar(require("./virtual-circuit-drg-attachment-network-create-details"));
exports.VirtualCircuitDrgAttachmentNetworkCreateDetails = VirtualCircuitDrgAttachmentNetworkCreateDetails.VirtualCircuitDrgAttachmentNetworkCreateDetails;
...
const VirtualCircuitDrgAttachmentNetworkUpdateDetails = __importStar(require("./virtual-circuit-drg-attachment-network-update-details"));
exports.VirtualCircuitDrgAttachmentNetworkUpdateDetails = VirtualCircuitDrgAttachmentNetworkUpdateDetails.VirtualCircuitDrgAttachmentNetworkUpdateDetails;
...
const ZprAllowedSecurityAction = __importStar(require("./zpr-allowed-security-action"));
exports.ZprAllowedSecurityAction = ZprAllowedSecurityAction.ZprAllowedSecurityAction;
const ZprCidrUnsupportedSecurityAction = __importStar(require("./zpr-cidr-unsupported-security-action"));
exports.ZprCidrUnsupportedSecurityAction = ZprCidrUnsupportedSecurityAction.ZprCidrUnsupportedSecurityAction;
const ZprConfiguration = __importStar(require("./zpr-configuration"));
exports.ZprConfiguration = ZprConfiguration.ZprConfiguration;
const ZprDeniedSecurityAction = __importStar(require("./zpr-denied-security-action"));
exports.ZprDeniedSecurityAction = ZprDeniedSecurityAction.ZprDeniedSecurityAction;
const ZprMissingPolicySecurityAction = __importStar(require("./zpr-missing-policy-security-action"));
exports.ZprMissingPolicySecurityAction = ZprMissingPolicySecurityAction.ZprMissingPolicySecurityAction;
const ZprNsgUnsupportedSecurityAction = __importStar(require("./zpr-nsg-unsupported-security-action"));
exports.ZprNsgUnsupportedSecurityAction = ZprNsgUnsupportedSecurityAction.ZprNsgUnsupportedSecurityAction;
const ZprPolicyNotEvaluatedMissingRouteSecurityAction = __importStar(require("./zpr-policy-not-evaluated-missing-route-security-action"));
exports.ZprPolicyNotEvaluatedMissingRouteSecurityAction = ZprPolicyNotEvaluatedMissingRouteSecurityAction.ZprPolicyNotEvaluatedMissingRouteSecurityAction;
const ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction = __importStar(require("./zpr-policy-not-evaluated-sl-nsg-denied-security-action"));
exports.ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction = ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction.ZprPolicyNotEvaluatedSlNsgDeniedSecurityAction;
